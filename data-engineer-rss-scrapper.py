...
CATEGORIES = {
    "클라우드/데이터웨어하우스": [
        "AWS S3", "AWS Glue", "AWS Redshift", "AWS Athena", "AWS Kinesis", "AWS Lambda", "AWS EMR",
        "Google BigQuery", "Google Dataflow", "Google Dataproc", "Google Pub/Sub",
        "Azure Synapse", "Azure Data Factory", "Azure Cosmos DB",
        "Snowflake", "Databricks", "Delta Lake", "Apache Hadoop", "HDFS"
    ],
    "데이터 처리/오케스트레이션": [
        "Apache Spark", "Apache Flink", "Apache Beam",
        "Apache Kafka", "Apache Airflow", "Prefect", "Dagster"
    ],
    "데이터베이스/스토리지": [
        "MySQL", "PostgreSQL", "Oracle Database", "MS SQL Server",
        "MongoDB", "Cassandra", "Redis",
        "Elasticsearch", "OpenSearch", "ClickHouse", "DuckDB", "SQLite"
    ],
    "분석/모델링/BI": [
        "dbt", "Looker", "Looker Studio", "Tableau", "Power BI", "Apache Superset", "Metabase"
    ],
    "머신러닝/임베딩/AI": [
        "TensorFlow", "PyTorch", "Hugging Face",
        "LangChain", "RAG", "Vector DB", "Chroma", "Pinecone", "Weaviate", "Milvus", "Qdrant", "Vespa",
        "MLflow"
    ],
    "인프라/DevOps": [
    ...
    "언어/라이브러리": [
        "Python pandas", "numpy", "polars", "pyarrow", "fastapi", "flask",
        "Scala", "Java Spring", "Go language", "Rust language"
    ],
    "보안/거버넌스": [
        "Apache Ranger", "Apache Atlas", "GDPR", "IAM", "Keycloak", "Okta"
    ],
    "데이터 트렌드": [
        "Data Mesh", "Data Fabric", "Real-time Analytics",
        "Batch Processing", "Streaming Processing", "ETL", "ELT",
        "Lakehouse Architecture", "Data Observability", "OpenTelemetry",
        "DataOps", "MLOps"
    ]
}
            ...
            for entry in all_entries:
                try:
                    ...
                    if len(batch) >= batch_size:
                        try:
                            result = supabase.table('data_engineer_news').upsert(batch, on_conflict='url').execute()
